...
const tableName = 'SystemAppLogChangeStation';
const primaryKeyField = 'systemAppLogChangeStationId';
    ...
    DB.schema.dropTableIfExists(`${tableName}`).then(() => {
      DB.schema
        .createTable(`${tableName}`, function (table) {
          ...
          table.string('dataValueBefore', 2000);
          table.string('dataValueAfter', 2000);
