...
const { APP_USER_CATEGORY, COMPANY_STATUS } = require('../AppUsersConstant');
    ...
    DB.schema.dropTableIfExists(`${tableName}`).then(() => {
      DB.schema
        .createTable(`${tableName}`, function (table) {
          ...
          table.string('userToken', 2000);
          table.string('socialInfo');
          table.string('firebaseToken', 2000);
          ...
          table.integer('appUserCategory').defaultTo(APP_USER_CATEGORY.PERSONAL_ACCOUNT);
