...
const insertSchema = {
  ...
  licenseDateFrom: Joi.string().example(moment().format(CUSTOMER_RECORD_DISPLAY_DATE_FORMAT)).allow(''),
  licenseDateEnd: Joi.string().example(moment().format(CUSTOMER_RECORD_DISPLAY_DATE_FORMAT)).allow(''),
