...
const { PERFORMER_TYPE } = require('../CustomerScheduleConstants');
const tableName = 'CustomerScheduleChange';
const primaryKeyField = 'customerScheduleChangeId';
    ...
    DB.schema.dropTableIfExists(`${tableName}`).then(() => {
      DB.schema
        .createTable(`${tableName}`, function (table) {
          ...
          table.integer('confirmedBy');
          table.string('canceledTime');
          table.string('confirmedTime');
          table.integer('canceledPerformerType'); // nguoi thuc hien huy lich
          table.integer('confirmedPerformerType'); // nguoi thuc hien xac nhan lich
