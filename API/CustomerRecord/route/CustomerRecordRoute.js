...
const { CUSTOMER_RECORD_DISPLAY_DATE_FORMAT } = require('../CustomerRecordConstants');
...
const insertSchema = {
  ...
  customerRecordCheckDate: Joi.string().required().example(CUSTOMER_RECORD_DISPLAY_DATE_FORMAT).length(10),
  customerRecordCheckExpiredDate: Joi.string().example(CUSTOMER_RECORD_DISPLAY_DATE_FORMAT).length(10),
...
const updateSchema = {
  ...
  customerRecordPlateImageUrl: Joi.string(),
  customerRecordPlateColor: Joi.string(),
  customerRecordCheckDate: Joi.string().example(CUSTOMER_RECORD_DISPLAY_DATE_FORMAT).length(10),
  customerRecordCheckExpiredDate: Joi.string().example(CUSTOMER_RECORD_DISPLAY_DATE_FORMAT).length(10),
