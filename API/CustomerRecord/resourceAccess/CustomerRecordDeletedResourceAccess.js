...
const tableName = 'CustomerRecordDeleted';
const primaryKeyField = 'customerRecordDeletedId';
    ...
    DB.schema.dropTableIfExists(`${tableName}`).then(() => {
      DB.schema
        .createTable(`${tableName}`, function (table) {
          ...
          table.string('customerRecordPlateColor');
          ...
          table.string('customerRecordCheckStatus');
          table.timestamp('customerRecordProcessCheckDate');
